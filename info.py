...
BOT_TOKEN = environ.get('BOT_TOKEN', "7164276438:AAGAs6eN45YJrDAfQ999aLG0e9qThH-5IAg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002010741325').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://silentmoviebot:N0LgOOG6dXrISePS@silentmoviebot.hpuwray.mongodb.net/?retryWrites=true&w=majority&appName=silentmoviebot")
DATABASE_NAME = environ.get('DATABASE_NAME', "silentmoviebot")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'uug3vvg-6WVlMjQ1') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://fikter1-d561fe187204.herokuapp.com/")
